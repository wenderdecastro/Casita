	...
	return (
		<NavigationContainer>
			...
			>
				...
				<Stack.Screen
					name={
						AppRoutesKeys.recoveryPasswordInsertEmailEscreen
					}
					component={
						RecoveryPasswordInsertEmailScreen
					}
				/>
				<Stack.Screen
					name={
						AppRoutesKeys.recoveryPasswordInsertCodeEscreen
					}
					component={
						RecoveryPasswordInsertCodeScreen
					}
				/>
				<Stack.Screen
					name={
					...
					component={
						RecoveryPasswordInsertNewPasswordScreen
					}
				/>
				<Stack.Screen
					name={
						AppRoutesKeys.registerUserDataPage
					}
					component={RegisterUserDataScreen}
				/>
				<Stack.Screen
					name={
						AppRoutesKeys.registerFinanceDataPage
					}
